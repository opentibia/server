...
//	LOG_MESSAGE("main", EVENT, 1, "Starting server");
	...
	char* p = new char[155];
	strcpy(p, "14299623962416399520070177382898895550795403345466153217470516082934737582776038882967213386204600674145392845853859217990626450972452084065728686565928113");
	char* q = new char[154];
	strcpy(q, "7630979195970404721891201847792002125535401292779123937207447574596692788513647179235335529307251350570728407373705564708871762033017096809910315212884101");
	char* d = new char[308];
	strcpy(d, "");
	g_otservRSA = new RSA();
