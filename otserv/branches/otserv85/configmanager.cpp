...
bool ConfigManager::loadFile(const std::string& _filename)
{
	...
	m_confInteger[RED_SKULL_DURATION] = getGlobalNumber(L, "red_skull_duration", 30*24*60*60*1000.0f);
	m_confInteger[BLACK_SKULL_DURATION] = getGlobalNumber(L, "red_skull_duration", 45*24*60*60*1000.0f);
