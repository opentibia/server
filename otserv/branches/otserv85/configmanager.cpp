...
bool ConfigManager::loadFile(const std::string& _filename)
{
	...
	m_confInteger[KILLS_PER_MONTH_RED_SKULL] = getGlobalNumber(L, "kills_per_week_red_skull", 10);
	...
	m_confInteger[KILLS_PER_MONTH_BLACK_SKULL] = getGlobalNumber(L, "kills_per_week_black_skull", 20);
	m_confInteger[RED_SKULL_DURATION] = getGlobalFloat(L, "red_skull_duration", 30*24*60*60*1000.0);
	m_confInteger[BLACK_SKULL_DURATION] = getGlobalFloat(L, "red_skull_duration", 45*24*60*60*1000.0);
