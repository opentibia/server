...
function enum(params, ...)
	...
	implementation:write("bool " .. enumbase .. "::initialized = false;\n")
	implementation:write("std::string " .. enumbase.. "::enum_name = \"" .. name .. "\";\n")
	implementation:write(enumbase .. "::EnumToString " .. enumbase .. "::enum_to_string;\n")
	implementation:write(enumbase .. "::StringToEnum " .. enumbase .. "::string_to_enum;\n")
	implementation:write(enumbase .. "::StringToEnum " .. enumbase .. "::lstring_to_enum;\n")
	
	-- Init function
	implementation:write("void " .. enumbase .. "::initialize()\n")
...
function BeginEnumFile(filename)
	...
	automated_text = "\n" ..
		...
		"// Do not make changes to this file manually, as they will as soon as the\n" ..
