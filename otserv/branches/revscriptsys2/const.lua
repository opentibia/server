...
enum ("MagicEffect", 
	...
	{"MAGIC_EFFECT_EXPLOSION_HIT        = 0x05", "explosionhit"},
	{"MAGIC_EFFECT_FIRE_AREA            = 0x06", "firearea"},
	{"MAGIC_EFFECT_YELLOW_RING          = 0x07", "yellowring"},
	{"MAGIC_EFFECT_GREEN_RING           = 0x08", "greenring"},
	{"MAGIC_EFFECT_BLACK_SPARK          = 0x09", "blackspark", "deathhit"},
	{"MAGIC_EFFECT_BLUE_BUBBLE          = 0x0A", "bluebubble", "teleport"},
	{"MAGIC_EFFECT_ENERGY_HIT           = 0x0B", "energyhit"},
	...
	{"MAGIC_EFFECT_DEATH_AREA           = 0x11", "deatharea", "blackbubble"},
	...
	{"MAGIC_EFFECT_FIRE_SPARK           = 0x24", "firespark"},
	...
	{"MAGIC_EFFECT_ICE_HIT              = 0x2B", "icehit"},
