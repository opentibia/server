...
/*
bool Spell::playerInstantSpellCheck(const Player* player, const std::string& param)
{
	LuaVariant var;
...
bool Spell::playerRuneSpellCheck(const Player* player, const Position& pos)
{
	...
	if(needTarget){
		Tile* tile = g_game.getTile(pos.x, pos.y, pos.x);
