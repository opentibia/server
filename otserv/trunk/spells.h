...
public:
	...
	RuneSpell* getRuneSpell(const uint32_t& id);
	...
	InstantSpell* getInstantSpellByIndex(const Player* player, const uint32_t& index);
...
public:
	...
	const uint32_t& getConjureId() const;
	const uint32_t& getConjureCount() const;
