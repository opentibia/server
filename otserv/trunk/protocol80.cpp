...
Protocol80::Protocol80(SOCKET s)
{
...
uint32_t Protocol80::getIP() const
{
	sockaddr_in sain;
...
void Protocol80::reinitializeProtocol(SOCKET _s)
{
	windowTextID = 0;
	readItem = NULL;
	maxTextLength = 0;
...
connectResult_t Protocol80::ConnectPlayer()
{
...
void Protocol80::ReceiveLoop()
{
	...
	do{
		...
		if(pendingLogout == false){
			...
			OTSYS_THREAD_LOCK(g_game.gameLock, "Protocol80::ReceiveLoop()");
			...
			OTSYS_THREAD_UNLOCK(g_game.gameLock, "Protocol80::ReceiveLoop()");
		}
...
void Protocol80::GetFloorDescription(NetworkMessage& msg, int x, int y, int z, int width, int height, int offset, int& skip)
{
	Tile* tile;
...
{
	OTSYS_THREAD_LOCK_CLASS lockClass(g_game.gameLock, "Protocol80::parseCreatePrivateChannel()");
	if(player->isRemoved()){
		return;
	}
...
void Protocol80::parseChannelInvite(NetworkMessage& msg)
{
	...
	OTSYS_THREAD_LOCK_CLASS lockClass(g_game.gameLock, "Protocol80::parseChannelInvite()");
	if(player->isRemoved()){
		return;
	}
...
void Protocol80::parseChannelExclude(NetworkMessage& msg)
{
	...
	OTSYS_THREAD_LOCK_CLASS lockClass(g_game.gameLock, "Protocol80::parseChannelExclude()");
	if(player->isRemoved()){
		return;
	}
...
{
	OTSYS_THREAD_LOCK_CLASS lockClass(g_game.gameLock, "Protocol80::parseGetChannels()");
	if(player->isRemoved()){
		return;
	}
...
void Protocol80::parseOpenChannel(NetworkMessage& msg)
{
	...
	OTSYS_THREAD_LOCK_CLASS lockClass(g_game.gameLock, "Protocol80::parseOpenChannel()");
	if(player->isRemoved()){
		return;
	}
...
{
	uint16_t channelId = msg.GetU16();
	OTSYS_THREAD_LOCK_CLASS lockClass(g_game.gameLock, "Protocol80::parseCloseChannel()");
	if(player->isRemoved()){
		return;
	}
...
void Protocol80::parseOpenPriv(NetworkMessage& msg)
{
	...
	OTSYS_THREAD_LOCK_CLASS lockClass(g_game.gameLock, "Protocol80::parseOpenPriv()");
	if(player->isRemoved()){
		return;
	}
...
{
	OTSYS_THREAD_LOCK_CLASS lockClass(g_game.gameLock, "Protocol80::parseReceivePing()");
	if(player->isRemoved()){
		return;
	}
...
void Protocol80::parseMoveNorth(NetworkMessage& msg)
{
	sleepTillMove();
...
void Protocol80::parseMoveEast(NetworkMessage& msg)
{
	sleepTillMove();
...
void Protocol80::parseMoveSouth(NetworkMessage& msg)
{
	sleepTillMove();
...
void Protocol80::parseMoveWest(NetworkMessage& msg)
{
	sleepTillMove();
...
void Protocol80::parseMoveNorthEast(NetworkMessage& msg)
{
	sleepTillMove();
	sleepTillMove();
...
void Protocol80::parseMoveSouthEast(NetworkMessage& msg)
{
	sleepTillMove();
	sleepTillMove();
...
void Protocol80::parseMoveSouthWest(NetworkMessage& msg)
{
	sleepTillMove();
	sleepTillMove();
...
void Protocol80::parseMoveNorthWest(NetworkMessage& msg)
{
	sleepTillMove();
	sleepTillMove();
...
void Protocol80::parseTurnNorth(NetworkMessage& msg)
{
	g_game.playerTurn(player, NORTH);
}

void Protocol80::parseTurnEast(NetworkMessage& msg)
{
	g_game.playerTurn(player, EAST);
}

void Protocol80::parseTurnSouth(NetworkMessage& msg)
{
	g_game.playerTurn(player, SOUTH);
}

void Protocol80::parseTurnWest(NetworkMessage& msg)
{
...
void Protocol80::parseCloseContainer(NetworkMessage& msg)
{
	...
	OTSYS_THREAD_LOCK_CLASS lockClass(g_game.gameLock, "Protocol80::parseCloseContainer()");
	if(player->isRemoved()){
		return;
	}
...
void Protocol80::parseUpArrowContainer(NetworkMessage& msg)
{
	...
	OTSYS_THREAD_LOCK_CLASS lockClass(g_game.gameLock, "Protocol80::parseUpArrowContainer()");
	if(player->isRemoved()){
		return;
	}
...
{
	uint32_t cid = msg.GetByte();
	OTSYS_THREAD_LOCK_CLASS lockClass(g_game.gameLock, "Protocol80::parseUpdateContainer()");
	if(player->isRemoved()){
		return;
	}
...
void Protocol80::parseHouseWindow(NetworkMessage &msg)
{
	...
	OTSYS_THREAD_LOCK_CLASS lockClass(g_game.gameLock, "Protocol80::parseHouseWindow()");
	if(player->isRemoved()){
		return;
	}
...
void Protocol80::parseRemVip(NetworkMessage& msg)
{
	uint32_t id = msg.GetU32();
	player->removeVIP(id);
}
...
// Send methods
void Protocol80::sendOpenPriv(const std::string& receiver)
{
...
void Protocol80::sendTextWindow(uint32_t itemid, const std::string& text)
{
	NetworkMessage msg;
	if(readItem){
		readItem->releaseThing2();
...
void Protocol80::sendHouseWindow(House* _house, uint32_t _listid, const std::string& text)
{
	NetworkMessage msg;
	windowTextID++;
	house = _house;
...
void Protocol80::AddCreatureSpeak(NetworkMessage& msg,const Creature* creature, SpeakClasses  type, std::string text, unsigned short channelId)
{
	msg.AddByte(0xAA);
	msg.AddU32(0);
...
void Protocol80::flushOutputBuffer()
{
	OTSYS_THREAD_LOCK_CLASS lockClass(bufferLock, "Protocol80::flushOutputBuffer()");
	//force writetosocket
...
void Protocol80::WriteBuffer(NetworkMessage& addMsg)
{
	if(!addMsg.empty()){
		g_game.addPlayerBuffer(player);

		OTSYS_THREAD_LOCK(bufferLock, "Protocol80::WriteBuffer");
		...
		OTSYS_THREAD_UNLOCK(bufferLock, "Protocol80::WriteBuffer");
	}
}

void Protocol80::setKey(const uint32_t* key)
{
	memcpy(m_key, key, 16);
