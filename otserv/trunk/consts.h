...
enum MagicEffectClasses {
	...
	NM_ME_SMALLCLOUDS      = 0x27, //38
	NM_ME_HOLYDAMAGE       = 0x28, //39
	NM_ME_BIGCLOUDS        = 0x29, //40
	NM_ME_ICEAREA          = 0x2A, //41
	NM_ME_ICETORNADO       = 0x2B, //42
	NM_ME_ICEATTACK        = 0x2C, //43
	NM_ME_STONES           = 0x2D, //44
	NM_ME_SMALLPLANTS      = 0x2E, //45
	NM_ME_CARNIPHILA       = 0x2F, //46
	NM_ME_PURPLEENERGY     = 0x30, //47
	NM_ME_YELLOWENERGY     = 0x31, //48
	NM_ME_HOLYAREA         = 0x32, //49
	NM_ME_BIGPLANTS        = 0x33, //50
	NM_ME_CAKE             = 0x34, //51
	NM_ME_GIANTICE         = 0x35, //52
	NM_ME_WATERSPLASH      = 0x36, //53
	NM_ME_PLANTATTACK      = 0x37, //54
