-- Scripts settings
GAMEMASTER_ACCESS = 3
TEST_SERVER = "off" -- options: on or off
LEVEL_DOOR_MSG = "default" -- options: default or leveltopass

-- Spells settings (do not modify)
COMBAT_TYPE_NULL = 0
...
COMBAT_PARAM_LEVELMAGICVALUECALLBACK = 9
COMBAT_PARAM_SKILLVALUECALLBACK = 10
