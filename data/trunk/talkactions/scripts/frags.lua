...
function onSay(cid, words, param)
	...
	if(skullticks > 0 and config.fragTime > 0) then
		...
		doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "You have " .. frags .. " unjustified frag" .. (frags > 1 and "s" or "") .. ". The amount of unjustified frags will decrease after: " .. hours .. " hours and " .. minutes .. " minutes.")
	else
