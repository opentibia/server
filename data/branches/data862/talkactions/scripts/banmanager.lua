...
-- usage /ban remove, ip, character_name -- will delete ban on IP (Can somebody check it out ? 0 errors in console (doesn't work I tried with many words as character_name))
